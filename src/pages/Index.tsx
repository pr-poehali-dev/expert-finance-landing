...
function Loans({ openModal }: { openModal: OpenModal }) {
  const products = [
    ...
    { title: "Под залог недвижимости", period: "до 180 мес.", amount: "до 3 000 000 ₽", icon: "Home", features: ["Максимальная сумма займа", "Длительный срок", "Индивидуальный подход"], badge: "Выгодно", color: "#c2251b", bg: "#f8fafc" },
    { title: "Ипотечный займ", period: "до 180 мес.", amount: "до 3 000 000 ₽", icon: "Building2", features: ["Покупка жилья", "Длительный срок", "Гибкие условия"], badge: "Ипотека", color: "#c2251b", bg: "#fff8f8" },
    { title: "Займ на авто", period: "до 84 мес.", amount: "до 2 000 000 ₽", icon: "Car", features: ["Покупка авто", "Под залог своего авто", "Быстрое решение"], badge: "Авто", color: "#c2251b", bg: "#f8fafc" },
    { title: "Рефинансирование", period: "до 180 мес.", amount: "до 3 000 000 ₽", icon: "RefreshCcw", features: ["Снижение ставки", "Объединение займов", "Уменьшение платежа"], badge: "Выгодно", color: "#c2251b", bg: "#fff8f8" },
    { title: "Займ для самозанятых", period: "до 60 мес.", amount: "до 1 000 000 ₽", icon: "Briefcase", features: ["Для самозанятых", "На развитие бизнеса", "Справка о доходах НПД"], badge: "Бизнес", color: "#c2251b", bg: "#f8fafc" },
  ];
