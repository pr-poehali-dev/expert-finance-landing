...
function Loans({ openModal }: { openModal: OpenModal }) {
  const products = [
    { title: "Потребительский займ", period: "до 60 мес.", amount: "до 300 000 ₽", icon: "CreditCard", features: ["Когда деньги нужны быстро и без залога", "Без залога", "Досрочное погашение", "Без скрытых комиссий"], badge: "Популярный", color: "#c2251b", bg: "#fff8f8" },
    { title: "Под залог недвижимости", period: "до 180 мес.", amount: "до 3 000 000 ₽", icon: "Home", features: ["Крупные суммы на длительный срок", "Максимальная сумма займа", "Длительный срок", "Индивидуальный подход"], badge: "Выгодно", color: "#c2251b", bg: "#f8fafc" },
    { title: "Ипотечный займ", period: "до 180 мес.", amount: "до 3 000 000 ₽", icon: "Building2", features: ["Реальный шанс купить своё жильё", "Покупка жилья", "Длительный срок", "Гибкие условия"], badge: "Ипотека", color: "#c2251b", bg: "#fff8f8" },
    { title: "Займ на авто", period: "до 84 мес.", amount: "до 2 000 000 ₽", icon: "Car", features: ["Купите авто уже сегодня", "Покупка авто", "Под залог своего авто", "Быстрое решение"], badge: "Авто", color: "#c2251b", bg: "#f8fafc" },
    { title: "Рефинансирование", period: "до 180 мес.", amount: "до 3 000 000 ₽", icon: "RefreshCcw", features: ["Снизьте платёж и объедините долги", "Снижение ставки", "Объединение займов", "Уменьшение платежа"], badge: "Выгодно", color: "#c2251b", bg: "#fff8f8" },
    { title: "Займ для самозанятых", period: "до 60 мес.", amount: "до 1 000 000 ₽", icon: "Briefcase", features: ["Для тех, кто работает на себя", "Для самозанятых", "На развитие бизнеса", "Справка о доходах НПД"], badge: "Бизнес", color: "#c2251b", bg: "#f8fafc" },
  ];
...
function Savings({ openModal }: { openModal: OpenModal }) {
  ...
  const calcIncome = () => {
    ...
    const monthly = sum * (rate / 100) / 12;
    return { income, total: sum + income, rate, monthly };
  };
                  ...
                  {!payAtEnd && (
                    <div className="flex items-center justify-between px-5 py-3.5 rounded-xl"
                      ...
                      <div className="flex items-center gap-2">
                        <Icon name="CalendarCheck" size={16} style={{ color: "#16a34a" }} />
                        <span className="font-manrope text-sm" style={{ color: "#15803d" }}>Ежемесячная выплата процентов</span>
                      </div>
                      <span className="font-oswald text-xl font-bold" style={{ color: "#16a34a" }}>
